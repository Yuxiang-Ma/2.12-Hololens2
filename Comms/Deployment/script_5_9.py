...
SAVE_RAVI = '/home/ravi/Desktop/Deployment/Deployment/display_image.png'
SAVE_PATH = SAVE_RAVI
...
r = [x_avg, y_avg, z_avg,  2.918710240827312, 1.0553194242490913, -0.015284460262501402]
#r = [0.04788, -0.76266, 0.17592, 2.941, 1.064, 0.010]





SAVE_PATH = SAVE_RAVI#"/home/ur5-2/roboresponse/manipulator/display_image.png" #"../img/display_image.png"
...
def plot_data(fig, axs, ts, forces, displacements, ROI=int(DISPLAY_PERIOD/READ_FREQ), save=True):
...
def plot_loop():
    while True:
        plot_data(fig, axs, t_out[-ROI:], force_out[-ROI:], pos_out[-ROI:])
...
for i in range(10000):
    ...
    #print("Current Position: ",rtde_r.getActualTCPPose())
